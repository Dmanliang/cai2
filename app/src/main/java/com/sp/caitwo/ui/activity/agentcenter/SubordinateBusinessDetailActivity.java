...
public class SubordinateBusinessDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subordinate_business_detail);
    ...
    public void setData() {
        ...
        InterfaceTask.getInstance().getSubordinateBusinessDetail(page,type, stateType, subStartDate, subEndDate,account,
    ...
    private void initUI() {
        ...
        tvTitle.setText(getString(R.string.subordinate_business_detail));
