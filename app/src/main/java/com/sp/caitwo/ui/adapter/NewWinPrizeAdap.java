...
import com.sp.caitwo.ui.fragment.home.NewWinPrizeFrag;
...
public class NewWinPrizeAdap extends RVBaseAdap<NewWinPrizeAdap.Holder> {

    private List<NewWinPrizeBean.DataBean> dataList;
    private Context context;
    private NewWinPrizeFrag frag;
    ...
    public NewWinPrizeAdap(NewWinPrizeFrag frag) {
    ...
    public Holder onCreateHolder(ViewGroup parent, int viewType) {
        return new Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_new_win_prize,parent,false));
    }
