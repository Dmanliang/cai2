...
public class UserBetRecordFrag extends Fragment {
    ...
    private ArrayList<BetRecordBean.DataBean> dataList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        inflate = inflater.inflate(R.layout.user_bet_record_frag, null);
    ...
    private void initUI() {
        ...
        mAdapter = new BetRecordAdapter(this);
    ...
    public void setData() {
        InterfaceTask.getInstance().getUserBetRecord(page, stateType, gameType, subStartDate, subEndDate,
                new InterfaceTask.OnInterfaceTask() {
                    ...
                    public void onSuccess(Object obj) {
                        ...
                        BetRecordBean json = (BetRecordBean) obj;
                        if (page == 1){
                            dataList.clear();
                        }
